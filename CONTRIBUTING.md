...
## Please make sure you are assigned to an [Issue](https://github.com/inspirezonetech/TeachMeBashLikeIm5/issues) before submitting a pull request

Go to the [issue](https://github.com/inspirezonetech/TeachMeBashLikeIm5/issues) page and either
...
## Use [shellcheck](https://www.shellcheck.net/) linting to ensure format of code is consistent with repo
